			...
			ToBoxes @ Grid[
				Partition[
					Button[
						Dynamic[
							Graphics[{
								Directive[EdgeForm[GrayLevel[0.7]], Thick],
								#1,
								Polygon[{{-1, 0}, {-0.9, 0.3}, {0.9, 0.3}, {1, 0}}],
								Text[
									Style[
										#2,
										If[MatchQ[CurrentValue[ButtonNotebook[], {TaggingRules, "TabValue"}], #3],
...
palleteNotebookExpression[] :=
	Notebook[
		...
		Background ->
			Dynamic[
				CurrentValue[EvaluationNotebook[], {TaggingRules, "TabValue"}] /. {
						1 -> RGBColor[0,0,0.258824],
						2 -> RGBColor[0.0541238,0.217197,0.109926](*,
						3 -> RGBColor[0.339361,0.323339,0.128634],
						4 -> RGBColor[0.339361,0.0686656,0.0576028]*)
						},
				TrackedSymbols :> {CurrentValue[EvaluationNotebook[], {TaggingRules, "TabValue"}]}
			],
		NotebookDynamicExpression :> Function[Needs["KnoxPackages`KCPalette`"]],
